/* Start Header ************************************************************************/
/*!
\file		SageRendererInternal.hpp
\title		Memory's Flame
\author		Yeo Jia Hao, jiahao.yeo, 2301325 (100%)
\par		jiahao.yeo@digipen.edu
\date		02 October 2024
\brief		The private interface that implement the renderer class that handles rendering of
...
class SageModel; //!< Forward declaration of SageModel.
class SageObject;//!< Forward declaration of SageObject. 
struct SageLine;//!< Forward declaration of SageLine.
struct SagePoint; //!< Forward declaration of SagePoint.
class SageTexture; //!< Forward declaration of SageTexture.
class SageShader; //!< Forward declaration of SageShader

class SageCamera; //!< Forward declaration of SageCamera.



/*!*****************************************************************************
\brief
	Rendererer configuration that modify the behaviour of the renderer.
...
struct RENDER_CONFIG_INTERNAL
{
	...
	/*!*****************************************************************************
	\brief
		Default constructor for the RENDER_CONFIG_INTERNAL struct.
...
/*!*****************************************************************************
\brief
	Encapsulate the  private interface of the renderer class that handle the
	rendering of objects and models.

	This struct contain the private interface of the renderer class that is used to
...
struct SageRendererInternal
{
	...
	enum //!< Bitmask options for the renderer configuration, currenet options are 4 bits
	{
		...
		I_SAGE_ENABLE_BORDER = 2, //!< Enable border
	...
	*******************************************************************************/
	...
	static RENDER_CONFIG_INTERNAL default_config; //!< The default configuration used when no configuration are specified
	static SageViewport viewport; //!< The active viewport for rendering.
	static SageShader* default_shader; //!< The active camera used for rendering.
	/*!*****************************************************************************
	\brief
